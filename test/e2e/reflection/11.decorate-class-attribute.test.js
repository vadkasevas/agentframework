...
const BadAgentChecker_1 = require("../attributes/BadAgentChecker");
const BadRandomAttribute_1 = require("../attributes/BadRandomAttribute");
...
MongoDB = __decorate([
    lib_1.decorateClass(new BadRandomAttribute_1.BadRandomAttribute())
], MongoDB);
describe('Decorate class attribute', () => {
    describe('# should able to', () => {
        ...
        it('re-upgrade agent', () => {
            expect(lib_1.CreateAgent(MongoDB, new BadAgentChecker_1.BadAgentChecker())).toBe(MongoDB);
        });
        it('new instance', () => {
