...
exports.FieldSetterInvocation = void 0;
const Prototype_1 = require("../../Helpers/Prototype");
/**
 * @ignore
 * @hidden
 */
class FieldSetterInvocation {
    constructor(design) {
        this.design = design;
    }
    invoke(params, receiver) {
        ...
        return Prototype_1.set(receiver, this.design.key, params[0]);
    }
}
exports.FieldSetterInvocation = FieldSetterInvocation;
