...
exports.InterceptorAttribute = void 0;
...
class InterceptorAttribute {
    ...
    intercept(target, params, receiver) {
        ...
        const newTarget = target.invoke(params, receiver);
        ...
        const proxies = FindExtendedClass_1.FindExtendedClass(oldTarget, newTarget);
        ...
        OnDemandClassCompiler_1.OnDemandClassCompiler.upgrade(proxies[0], properties, proxies[0], proxies[1]);
        return newTarget;
    }
}
exports.InterceptorAttribute = InterceptorAttribute;
